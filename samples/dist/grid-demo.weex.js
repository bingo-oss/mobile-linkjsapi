...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gridDemo = __webpack_require__(176);

	var _gridDemo2 = _interopRequireDefault(_gridDemo);
	...
	_gridDemo2.default.el = '#root';

	new Vue(_gridDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/grid-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-2ec7c03d"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getChildListByOrgId: function getChildListByOrgId() {
	            var _this = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this.linkapi.getChildListByOrgId(res.orgId, 1, 2, function (resp) {
	                    _this.$alert(resp);
	                }, function (error) {
	                    _this.$alert(error);
	                });
	        ...
	        getDeptInfoById: function getDeptInfoById() {
	            var _this2 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this2.linkapi.getDeptInfoById(res.orgId, function (resp) {
	                    _this2.$alert(resp);
	                }, function (error) {
	                    _this2.$alert(error);
	                });
	        ...
	        execSyncService: function execSyncService() {
	            var _this3 = this;

	            //type 同步类型。 0：用户信息同步，1：群组信息同步，2：部门信息同步，3：服务号信息同步，4：好友企业同步，5：应用同步
	            this.linkapi.execSyncService(0, function (resp) {
	                _this3.$alert(resp);
	            }, function (error) {
	                _this3.$alert(error);
	            });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '根据部门id获取用户信息以及子部门信息(getChildListByOrgId)'
	    },
	    on: {
	      "cellClick": _vm.getChildListByOrgId
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '根据部门id获取该部门的信息(getDeptInfoById)'
	    },
	    on: {
	      "cellClick": _vm.getDeptInfoById
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '执行同步服务(execSyncService)'
	    },
	    on: {
	      "cellClick": _vm.execSyncService
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _diskDemo = __webpack_require__(168);

	var _diskDemo2 = _interopRequireDefault(_diskDemo);
	...
	_diskDemo2.default.el = '#root';

	new Vue(_diskDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/disk-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-c61e2074"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        chooseDiskFile: function chooseDiskFile() {
	            var _this = this;

	            this.linkapi.chooseDiskFile(function (res) {
	                //成功选择文件回调,返回 id、name、size
	                _this.$alert(res);
	            });
	        },
	        createDiskFileShare: function createDiskFileShare() {
	            var _this2 = this;

	            this.linkapi.chooseDiskFile(function (res) {
	                //成功选择文件回调,返回 id、name、size
	                _this2.linkapi.createDiskFileShare(res.id, function (resp) {
	                    //成功回调，返回{Object} 公开分享具体参数：shareId、shareName、baseUrl、password、shareHref
	                    _this2.$alert(resp);
	                });
	            });
	        },
	        openDiskFileDetail: function openDiskFileDetail() {
	            var _this3 = this;

	            this.linkapi.openDiskFileDetail("986d4e2b-6966-496e-82af-ab9770cb96f7", {}, function (resp) {
	                _this3.$alert("成功回调");
	                _this3.$alert(resp);
	            }, function (error) {
	                _this3.$alert("失败回调");
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开云盘选择文件(单选)(chooseDiskFile)'
	    },
	    on: {
	      "cellClick": _vm.chooseDiskFile
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '创建云盘分享(createDiskFileShare)'
	    },
	    on: {
	      "cellClick": _vm.createDiskFileShare
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '查看云盘文件详情(openDiskFileDetail)'
	    },
	    on: {
	      "cellClick": _vm.openDiskFileDetail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

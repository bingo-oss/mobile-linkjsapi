...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _locationDemo = __webpack_require__(188);

	var _locationDemo2 = _interopRequireDefault(_locationDemo);
	...
	_locationDemo2.default.el = '#root';

	new Vue(_locationDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/location-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-67b6732e"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        startCheckIn: function startCheckIn() {
	            this.linkapi.startCheckIn();
	        },
	        openCheckInList: function openCheckInList() {
	            this.linkapi.openCheckInList();
	        },
	        openCheckInDetail: function openCheckInDetail() {
	            this.linkapi.openCheckInDetail("deabc66a-e36e-4906-872a-040b96d025cf");
	        },
	        startLocationSelect: function startLocationSelect() {
	            var _this = this;

	            this.linkapi.startLocationSelect({
	                'title': 'location'
	            }, function (res) {
	                _this.$alert(res);
	            });
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开“我要签到”界面(startCheckIn)'
	    },
	    on: {
	      "cellClick": _vm.startCheckIn
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '打开“签到列表”界面(openCheckInList)'
	    },
	    on: {
	      "cellClick": _vm.openCheckInList
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开签到详情页面(openCheckInDetail)'
	    },
	    on: {
	      "cellClick": _vm.openCheckInDetail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开地理定位界面，选择后返回(startLocationSelect)'
	    },
	    on: {
	      "cellClick": _vm.startLocationSelect
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

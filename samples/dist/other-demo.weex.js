...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _otherDemo = __webpack_require__(212);

	var _otherDemo2 = _interopRequireDefault(_otherDemo);
	...
	_otherDemo2.default.el = '#root';

	new Vue(_otherDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/other-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-1165dddd"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        updateTabBadge: function updateTabBadge() {
	            this.linkapi.updateTabBadge(100);
	        },
	        getThemeColor: function getThemeColor() {
	            var _this = this;

	            this.linkapi.getThemeColor(function (res) {
	                //返回颜色值
	                _this.$alert(res);
	            });
	        },
	        ...
	        getLanguage: function getLanguage() {
	            ...
	            this.linkapi.getLanguage(function (res) {
	                _this4.$alert("回调成功");
	                _this4.$alert(res);
	            });
	        },
	        selectFiles: function selectFiles() {
	            ...
	            this.linkapi.selectFiles(1, function (res) {
	                _this5.$alert("回调成功");
	                _this5.$alert(res);
	            });
	        },
	        ...
	        openFile: function openFile() {
	            ...
	            this.linkapi.selectFiles(2, function (res) {
	                _this7.$alert("回调成功");
	                _this7.$alert(res);
	                // this.linkapi.openFile(res);
	                _this7.linkapi.openFile(res.resource[0]);
	            });
	        },
	        registerReceiver: function registerReceiver() {
	            var _this8 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000010', function (res) {
	                _this8.linkapi.registerReceiver(1, res.userId);
	            });
	        },
	        updateMessageTabBadge: function updateMessageTabBadge() {
	            this.linkapi.updateMessageTabBadge({
	                "appCode": "",
	                "unReadCount": 8
	            });
	        },
	        cancelMsgNtf: function cancelMsgNtf() {
	            var _this9 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000010', function (res) {
	                _this9.linkapi.cancelMsgNtf(res.userId);
	            });
	        },
	        cancelMsgNtfByCategoryId: function cancelMsgNtfByCategoryId() {
	            var _this10 = this;

	            this.linkapi.getFavoriteApp(function (resp) {
	                _this10.$alert(resp);
	                _this10.linkapi.cancelMsgNtfByCategoryId(resp[0].category);
	            });
	        },
	        setChatActionTip: function setChatActionTip() {
	        ...
	        readTextFromFile: function readTextFromFile() {
	            var _this12 = this;

	            this.linkapi.readTextFromFile('', '', function (res) {
	                _this12.$alert("回调成功");
	                _this12.$alert(res);
	            }, function (error) {
	                _this12.$alert("回调失败");
	        ...
	        getLoginCookies: function getLoginCookies() {
	            var _this13 = this;

	            this.linkapi.getLoginCookies(function (res) {
	                _this13.$alert("回调成功");
	                _this13.$alert(res);
	            }, function (error) {
	                _this13.$alert("回调失败");
	        ...
	        getDomainRequireAuthUrls: function getDomainRequireAuthUrls() {
	            var _this14 = this;

	            this.linkapi.getDomainRequireAuthUrls(function (res) {
	                _this14.$alert("回调成功");
	                _this14.$alert(res);
	            }, function (error) {
	                _this14.$alert("回调失败");
	        ...
	        getImage: function getImage() {
	            ...
	            this.linkapi.getFavoriteApp(function (resp) {
	                _this15.linkapi.getImage(resp[0].icon, function (res) {
	                    _this15.$alert("回调成功");
	                    _this15.$alert(res);
	                }, function (error) {
	                    _this15.$alert("回调失败");
	        ...
	        getEmailUnreadCount: function getEmailUnreadCount() {
	            var _this16 = this;

	            this.linkapi.getEmailUnreadCount(function (resp) {
	                _this16.$alert(resp);
	                _this16.$alert("回调成功");
	                _this16.$alert(resp);
	            }, function (error) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    attrs: {
	      "title": "云盘",
	      "leftItem": _vm.leftItem
	    },
	    on: {
	      "leftClick": _vm.back
	    }
	  }), _c('scroller', [_c('bui-cell', {
	    attrs: {
	      "title": '更新消息的角标(updateTabBadge)'
	    },
	    on: {
	      "cellClick": _vm.updateTabBadge
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '获取当前Link的主题颜色值(getThemeColor)'
	    },
	    on: {
	      "cellClick": _vm.getThemeColor
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开录制小视频(openVideoRecord)'
	    },
	    on: {
	      "cellClick": _vm.openVideoRecord
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开二维码扫码(自动解析指令，自动跳转)(scanCode)'
	    },
	    on: {
	      "cellClick": _vm.scanCode
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开二维码扫码(可设置直接返回扫码内容，不自行解析)(scanCodeHandle)'
	    },
	    on: {
	      "cellClick": _vm.scanCodeHandle
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开Link内置浏览器(openLinkBroswer)'
	    },
	    on: {
	      "cellClick": _vm.openLinkBroswer
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开BT容器，传入url(openBtBroswer)'
	    },
	    on: {
	      "cellClick": _vm.openBtBroswer
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开pdf文件：url支持本地以及远程的地址(openPdfBroswer)'
	    },
	    on: {
	      "cellClick": _vm.openPdfBroswer
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '选择文件(chooseFile)'
	    },
	    on: {
	      "cellClick": _vm.chooseFile
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取当前语言环境(getLanguage)'
	    },
	    on: {
	      "cellClick": _vm.getLanguage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '发起选择文件资源(selectFiles)'
	    },
	    on: {
	      "cellClick": _vm.selectFiles
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '发起资源上传(uploadFiles)'
	    },
	    on: {
	      "cellClick": _vm.uploadFiles
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开/浏览上传后的资源(openFile)'
	    },
	    on: {
	      "cellClick": _vm.openFile
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '注册广播接收器。注册后可以通过key监听全局消息(registerReceiver)'
	    },
	    on: {
	      "cellClick": _vm.registerReceiver
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '更新消息界面tab的角标(updateMessageTabBadge)'
	    },
	    on: {
	      "cellClick": _vm.updateMessageTabBadge
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '取消指定聊天对象的通知栏信息(cancelMsgNtf)'
	    },
	    on: {
	      "cellClick": _vm.cancelMsgNtf
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '根据类型清除通知栏的通知(cancelMsgNtfByCategoryId)'
	    },
	    on: {
	      "cellClick": _vm.cancelMsgNtfByCategoryId
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '设置聊天界面右上角的气泡未读数(setChatActionTip)'
	    },
	    on: {
	      "cellClick": _vm.setChatActionTip
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '发送消息通用方法(sendMessage)'
	    },
	    on: {
	      "cellClick": _vm.sendMessage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '读取文件文本内容(readTextFromFile)'
	    },
	    on: {
	      "cellClick": _vm.readTextFromFile
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开搜索界面(startSearch)'
	    },
	    on: {
	      "cellClick": _vm.startSearch
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开语音助手(speechAssistant)'
	    },
	    on: {
	      "cellClick": _vm.speechAssistant
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取Link登录的cookie信息(getLoginCookies)'
	    },
	    on: {
	      "cellClick": _vm.getLoginCookies
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取需要授权认证的url(getDomainRequireAuthUrls)'
	    },
	    on: {
	      "cellClick": _vm.getDomainRequireAuthUrls
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取link图片物理地址,根据内部定的协议获取真实的物理地址(getImage)'
	    },
	    on: {
	      "cellClick": _vm.getImage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '发起聊天(startChat)'
	    },
	    on: {
	      "cellClick": _vm.startChat
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开待办待阅(openTodo)'
	    },
	    on: {
	      "cellClick": _vm.openTodo
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开邮箱(startEmail)'
	    },
	    on: {
	      "cellClick": _vm.startEmail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取未读邮箱条数(getEmailUnreadCount)'
	    },
	    on: {
	      "cellClick": _vm.getEmailUnreadCount
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开在线客服(openOnlineServicer)'
	    },
	    on: {
	      "cellClick": _vm.openOnlineServicer
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

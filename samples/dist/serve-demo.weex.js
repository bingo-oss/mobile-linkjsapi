...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _serveDemo = __webpack_require__(220);

	var _serveDemo2 = _interopRequireDefault(_serveDemo);
	...
	_serveDemo2.default.el = '#root';

	new Vue(_serveDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/serve-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-679538be"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        sendServiceAccountNotice: function sendServiceAccountNotice() {
	            this.linkapi.sendServiceAccountNotice("70975e19-6b70-46ec-86a6-9788f1eb5457", 0);
	        },
	        openServiceAccountCard: function openServiceAccountCard() {
	            this.linkapi.openServiceAccountCard("70975e19-6b70-46ec-86a6-9788f1eb5457");
	        },
	        openServiceAccountList: function openServiceAccountList() {
	            this.linkapi.openServiceAccountList();
	        },
	        addServiceAcccount: function addServiceAcccount() {
	            this.linkapi.addServiceAcccount();
	        },
	        startServiceAccountChat: function startServiceAccountChat() {
	            this.linkapi.startServiceAccountChat("70975e19-6b70-46ec-86a6-9788f1eb5457");
	        }
	    },
	    mounted: function mounted() {}
	};
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '发送服务号公告(sendServiceAccountNotice)'
	    },
	    on: {
	      "cellClick": _vm.sendServiceAccountNotice
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '查看服务号名片页(openServiceAccountCard)'
	    },
	    on: {
	      "cellClick": _vm.openServiceAccountCard
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '查看已关注服务号列表(openServiceAccountList)'
	    },
	    on: {
	      "cellClick": _vm.openServiceAccountList
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开添加服务号页面(addServiceAcccount)'
	    },
	    on: {
	      "cellClick": _vm.addServiceAcccount
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开服务号聊天界面(startServiceAccountChat)'
	    },
	    on: {
	      "cellClick": _vm.startServiceAccountChat
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _orgDemo = __webpack_require__(208);

	var _orgDemo2 = _interopRequireDefault(_orgDemo);
	...
	_orgDemo2.default.el = '#root';

	new Vue(_orgDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/org-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-5a08a9c9"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        openOrgList: function openOrgList() {
	            var _this = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this.linkapi.openOrgList(res.orgId);
	            });
	        },
	        openOrgCard: function openOrgCard() {
	            var _this2 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this2.linkapi.openOrgCard(res.orgId);
	            });
	        }
	    },
	    mounted: function mounted() {}
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开部门列表(openOrgList)'
	    },
	    on: {
	      "cellClick": _vm.openOrgList
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '查看部门名片页(openOrgCard)'
	    },
	    on: {
	      "cellClick": _vm.openOrgCard
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

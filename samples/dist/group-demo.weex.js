...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _groupDemo = __webpack_require__(180);

	var _groupDemo2 = _interopRequireDefault(_groupDemo);
	...
	_groupDemo2.default.el = '#root';

	new Vue(_groupDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/group-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-7df55964"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	module.exports = {
	    ...
	    methods: (_methods = {
	        ...
	        createGroup: function createGroup() {
	            ...
	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this.linkapi.createGroup(res.userId, function (res) {
	                    _this.$alert(res);
	                }, function (error) {
	                    _this.$alert(error);
	                });
	        ...
	        joinGroup: function joinGroup() {
	            ...
	            this.linkapi.getUserInfoByCellphoneOrEmail('16600000001', function (res) {
	                _this2.linkapi.joinGroup('f87a23ed-9662-4a91-9a3b-ff680873e5dd', [res.userId], function (respone) {
	                    _this2.$alert("回调成功");
	                    _this2.$alert(respone);
	                }, function (error) {
	                    _this2.$alert("回调失败");
	                    _this2.$alert(error);
	                });
	        ...
	        startGroupCard: function startGroupCard() {
	            var _this3 = this;

	            this.linkapi.startGroupCard('f87a23ed-9662-4a91-9a3b-ff680873e5dd', function (resp) {
	                _this3.$alert(resp);
	            }, function (error) {
	                _this3.$alert(error);
	            });
	        },
	        sendGroupNotice: function sendGroupNotice() {
	            this.linkapi.sendGroupNotice('f87a23ed-9662-4a91-9a3b-ff680873e5dd');
	        },
	        openGroupNoticeList: function openGroupNoticeList() {
	        ...
	        openGroupBulletinDetail: function openGroupBulletinDetail() {
	        ...
	        startGroupBulletinEdit: function startGroupBulletinEdit() {
	    ...
	    }, _defineProperty(_methods, 'startGroupChat', function startGroupChat() {
	        this.linkapi.startGroupChat('f87a23ed-9662-4a91-9a3b-ff680873e5dd');
	    }), _defineProperty(_methods, 'startGroupChat', function startGroupChat() {
	        this.linkapi.startGroupChat('f87a23ed-9662-4a91-9a3b-ff680873e5dd');
	    }), _methods),
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '创建群组(createGroup)'
	    },
	    on: {
	      "cellClick": _vm.createGroup
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '加入群组(joinGroup)'
	    },
	    on: {
	      "cellClick": _vm.joinGroup
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开群组列表(openGroupList)'
	    },
	    on: {
	      "cellClick": _vm.openGroupList
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开群组的名片页面(startGroupCard)'
	    },
	    on: {
	      "cellClick": _vm.startGroupCard
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开群组发公告页面(sendGroupNotice)'
	    },
	    on: {
	      "cellClick": _vm.sendGroupNotice
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开群组公告列表(openGroupNoticeList)'
	    },
	    on: {
	      "cellClick": _vm.openGroupNoticeList
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '该接口用于调用Link的群组聊天页面(startGroupChat)'
	    },
	    on: {
	      "cellClick": _vm.startGroupChat
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开一个群组公告详情(openGroupBulletinDetail)'
	    },
	    on: {
	      "cellClick": _vm.openGroupBulletinDetail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开群公告发表界面(startGroupBulletinEdit)'
	    },
	    on: {
	      "cellClick": _vm.startGroupBulletinEdit
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

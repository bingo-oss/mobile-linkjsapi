...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _notebookDemo = __webpack_require__(204);

	var _notebookDemo2 = _interopRequireDefault(_notebookDemo);
	...
	_notebookDemo2.default.el = '#root';

	new Vue(_notebookDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/notebook-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-142a7bc8"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        startContactSingleSelector: function startContactSingleSelector() {
	            var _this = this;

	            this.linkapi.startContactSingleSelector("单选选人", 1, function (res) {
	                _this.$alert(res);
	            }, function (error) {
	                _this.$alert(error);
	            });
	        },
	        startContactMulitSelector: function startContactMulitSelector() {
	            var _this2 = this;

	            this.linkapi.startContactMulitSelector("多选选人", 1, function (res) {
	                _this2.$alert(res);
	            }, function (error) {
	                _this2.$alert(error);
	            });
	        },
	        onRemoveFromSelectedArea: function onRemoveFromSelectedArea() {
	            this.$alert('监听全局移除事件----@param model : 选择的model，包含id,name,icon,type');
	        },
	        startUserCard: function startUserCard() {
	            var _this3 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this3.linkapi.startUserCard(res.userId);
	            });
	        },
	        openContactPage: function openContactPage() {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '调用平台选人界面(单选)(startContactSingleSelector)'
	    },
	    on: {
	      "cellClick": _vm.startContactSingleSelector
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '调用平台选人界面(多选)(startContactMulitSelector)'
	    },
	    on: {
	      "cellClick": _vm.startContactMulitSelector
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '选人界面扩展事件：监听全局移除事件(onRemoveFromSelectedArea)'
	    },
	    on: {
	      "cellClick": _vm.onRemoveFromSelectedArea
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开指定userId用户的名片(startUserCard)'
	    },
	    on: {
	      "cellClick": _vm.startUserCard
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开通讯录页面(openContactPage)'
	    },
	    on: {
	      "cellClick": _vm.openContactPage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

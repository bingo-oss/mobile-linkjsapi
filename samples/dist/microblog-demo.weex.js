...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _microblogDemo = __webpack_require__(192);

	var _microblogDemo2 = _interopRequireDefault(_microblogDemo);
	...
	_microblogDemo2.default.el = '#root';

	new Vue(_microblogDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/microblog-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-650ca6c7"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        publishMicroblog: function publishMicroblog() {
	            var _this = this;

	            this.linkapi.getLoginInfo(function (res) {
	                _this.linkapi.publishMicroblog({
	                    'authorID': res.userId,
	                    'content': '发现了其中的奥妙~赞',
	                    'privateType': 2
	                }, function (resp) {
	        ...
	        openUserMicroblog: function openUserMicroblog() {
	            var _this2 = this;

	            this.linkapi.getLoginInfo(function (res) {
	                _this2.linkapi.openUserMicroblog(res.userId);
	            });
	        },
	        openGroupMicroblog: function openGroupMicroblog() {
	            this.linkapi.openGroupMicroblog('a6018ac0-b462-427e-9838-722d4ccfd6a2');
	        },
	        openServiceAccountMicroblog: function openServiceAccountMicroblog() {
	            this.linkapi.openServiceAccountMicroblog('70975e19-6b70-46ec-86a6-9788f1eb5457');
	        },
	        openTopicMicroblog: function openTopicMicroblog() {
	            this.linkapi.openTopicMicroblog('发进卡里的交罚款');
	        },
	        openMicroblogDetail: function openMicroblogDetail() {
	        ...
	        openMyMicroblog: function openMyMicroblog() {
	            ...
	            this.linkapi.getLoginInfo(function (res) {
	                _this3.linkapi.openMyMicroblog();
	            });
	        },
	        openMicroblogCenter: function openMicroblogCenter() {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '发表动态(publishMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.publishMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '打开某人动态主页(openUserMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.openUserMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开某群组动态主页(openGroupMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.openGroupMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开某服务号动态主页(openServiceAccountMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.openServiceAccountMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开某话题动态主页(openTopicMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.openTopicMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开动态详情(openMicroblogDetail)'
	    },
	    on: {
	      "cellClick": _vm.openMicroblogDetail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开个人动态主页(openMyMicroblog)'
	    },
	    on: {
	      "cellClick": _vm.openMyMicroblog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开动态主页(openMicroblogCenter)'
	    },
	    on: {
	      "cellClick": _vm.openMicroblogCenter
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _myDemo = __webpack_require__(200);

	var _myDemo2 = _interopRequireDefault(_myDemo);
	...
	_myDemo2.default.el = '#root';

	new Vue(_myDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/my-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-0fef7b57"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        openPersonEdit: function openPersonEdit() {
	            this.linkapi.openPersonEdit();
	        },
	        openSetting: function openSetting() {
	            this.linkapi.openSetting();
	        },
	        openAbout: function openAbout() {
	            this.linkapi.openAbout();
	        },
	        openStNotification: function openStNotification() {
	            this.linkapi.openStNotification();
	        },
	        openStGestureLock: function openStGestureLock() {
	            var _this = this;

	            this.linkapi.openStGestureLock(function (res) {
	                _this.$alert(res);
	            });
	        },
	        openStFont: function openStFont() {
	            this.linkapi.openStFont();
	        },
	        openStDevice: function openStDevice() {
	            this.linkapi.openStDevice();
	        },
	        openStSync: function openStSync() {
	            this.linkapi.openStSync();
	        },
	        openStCleanCache: function openStCleanCache() {
	            this.linkapi.openStCleanCache();
	        },
	        openStModifyPassword: function openStModifyPassword() {
	            this.linkapi.openStModifyPassword();
	        },
	        openStInvite: function openStInvite() {
	            this.linkapi.openStInvite();
	        },
	        openStQrcode: function openStQrcode() {
	            this.linkapi.openStQrcode();
	        },
	        logout: function logout() {
	            this.linkapi.logout();
	        }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开个人信息修改页面(openPersonEdit)'
	    },
	    on: {
	      "cellClick": _vm.openPersonEdit
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '打开个人设置页面(openSetting)'
	    },
	    on: {
	      "cellClick": _vm.openSetting
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开关于页面(openAbout)'
	    },
	    on: {
	      "cellClick": _vm.openAbout
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开设置消息通知页面(openStNotification)'
	    },
	    on: {
	      "cellClick": _vm.openStNotification
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开设置手势锁屏页面(openStGestureLock)'
	    },
	    on: {
	      "cellClick": _vm.openStGestureLock
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开设置字体大小页面(openStFont)'
	    },
	    on: {
	      "cellClick": _vm.openStFont
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开设备管理页面(openStDevice)'
	    },
	    on: {
	      "cellClick": _vm.openStDevice
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开手工同步页面(openStSync)'
	    },
	    on: {
	      "cellClick": _vm.openStSync
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开清除缓存页面(openStCleanCache)'
	    },
	    on: {
	      "cellClick": _vm.openStCleanCache
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开修改密码页面(openStModifyPassword)'
	    },
	    on: {
	      "cellClick": _vm.openStModifyPassword
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开邀请好友页面(openStInvite)'
	    },
	    on: {
	      "cellClick": _vm.openStInvite
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开二维码页面(openStQrcode)'
	    },
	    on: {
	      "cellClick": _vm.openStQrcode
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _msgDemo = __webpack_require__(196);

	var _msgDemo2 = _interopRequireDefault(_msgDemo);
	...
	_msgDemo2.default.el = '#root';

	new Vue(_msgDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/msg-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-40ebdc68"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getUnreadMessageCount: function getUnreadMessageCount() {
	            ...
	            this.linkapi.getUnreadMessageCount(function (resp) {
	                _this.$alert(resp);
	            });
	        },
	        getUnreadMessageCountById: function getUnreadMessageCountById() {
	            var _this2 = this;
	            ...
	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                 ...
	                 * @param talkWithId {string} 这里的帐号包括：用户的id，服务号的id，部门的id，群组的id
	                 */
	                _this2.linkapi.getUnreadMessageCountById(res.userId, function (resp) {
	                    _this2.$alert(resp);
	                });
	            });
	        },
	        sendInviteMessage: function sendInviteMessage() {
	            var _this3 = this;

	            //该方法需在消息对话窗口执行
	            this.linkapi.getFavoriteApp(function (resp) {
	                _this3.linkapi.sendInviteMessage({
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开消息中心页面(openMsgCenter)'
	    },
	    on: {
	      "cellClick": _vm.openMsgCenter
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '获取未读消息总数(getUnreadMessageCount)'
	    },
	    on: {
	      "cellClick": _vm.getUnreadMessageCount
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取未读消息总数(getUnreadMessageCountById)'
	    },
	    on: {
	      "cellClick": _vm.getUnreadMessageCountById
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '发送邀约消息(sendInviteMessage)'
	    },
	    on: {
	      "cellClick": _vm.sendInviteMessage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

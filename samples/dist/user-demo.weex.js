...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _userDemo = __webpack_require__(224);

	var _userDemo2 = _interopRequireDefault(_userDemo);
	...
	_userDemo2.default.el = '#root';

	new Vue(_userDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/user-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-4a152558"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getToken: function getToken() {
	            ...
	            this.linkapi.getToken(function (res) {
	                _this2.$alert(res);
	            }, function (error) {
	                _this2.$alert(error);
	            });
	        ...
	        refreshToken: function refreshToken() {
	            ...
	            this.linkapi.refreshToken(function (res) {
	                _this3.$alert(res);
	            }, function (error) {
	                _this3.$alert(error);
	            });
	        ...
	        getUserInfo: function getUserInfo() {
	            ...
	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this4.linkapi.getUserInfo(res.userId, function (resp) {
	                    _this4.$alert(resp);
	                }, function (error) {
	                    _this4.$alert(error);
	                });
	        ...
	        getUserIdWithLoginId: function getUserIdWithLoginId() {
	            var _this5 = this;

	            this.linkapi.getLoginInfo(function (res) {
	                _this5.$alert(res);
	                _this5.linkapi.getUserIdWithLoginId(res.loginId, function (resp) {
	                    _this5.$alert(resp);
	                }, function (error) {
	                    _this5.$alert(error);
	                });
	        ...
	        getUserInfoByCellphoneOrEmail: function getUserInfoByCellphoneOrEmail() {
	            var _this6 = this;
	        ...
	        startUserChat: function startUserChat() {
	            var _this7 = this;

	            this.linkapi.getUserInfoByCellphoneOrEmail('17900000016', function (res) {
	                _this7.linkapi.startUserChat(res.userId);
	            });
	        }
	    },
	    mounted: function mounted() {}
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '获取登陆后的用户信息(getLoginInfo)'
	    },
	    on: {
	      "cellClick": _vm.getLoginInfo
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '获取登录用户凭证 AccessToken(getToken)'
	    },
	    on: {
	      "cellClick": _vm.getToken
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '刷新平台的 AccessToken(refreshToken)'
	    },
	    on: {
	      "cellClick": _vm.refreshToken
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取指定userId的用户信息,支持批量获取(getUserInfo)'
	    },
	    on: {
	      "cellClick": _vm.getUserInfo
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '根据loginId获取userId(getUserIdWithLoginId)'
	    },
	    on: {
	      "cellClick": _vm.getUserIdWithLoginId
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '根据手机或者邮箱获取用户信息(getUserInfoByCellphoneOrEmail)'
	    },
	    on: {
	      "cellClick": _vm.getUserInfoByCellphoneOrEmail
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '该接口用于调用Link的用户聊天页面(startUserChat)'
	    },
	    on: {
	      "cellClick": _vm.startUserChat
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

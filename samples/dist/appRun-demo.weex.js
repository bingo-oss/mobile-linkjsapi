...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _appRunDemo = __webpack_require__(164);

	var _appRunDemo2 = _interopRequireDefault(_appRunDemo);
	...
	_appRunDemo2.default.el = '#root';

	new Vue(_appRunDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/appRun-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-675e5899"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        runApp: function runApp() {
	            ...
	            this.linkapi.getFavoriteApp(function (res) {
	                _this.$alert(res);
	                // this.linkapi.runApp({
	                //     'authorID': res.userId,
	                //     'content': '发现了其中的奥妙~赞',
	        ...
	        launchLinkService: function launchLinkService() {
	            var _this2 = this;

	            this.linkapi.getFavoriteApp(function (res) {
	                _this2.linkapi.launchLinkService(JSON.parse(res)[0].actionParams, function (resp) {
	                    _this2.$alert('回调');
	                });
	            });
	        },
	        ...
	        getFavoriteApp: function getFavoriteApp() {
	            var _this3 = this;
	        ...
	        openMyMicroblog: function openMyMicroblog() {
	            ...
	            this.linkapi.getLoginInfo(function (res) {
	                _this4.linkapi.openMyMicroblog();
	            });
	        },
	        openMicroblogCenter: function openMicroblogCenter() {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '该方法用于app里面启动app(runApp)'
	    },
	    on: {
	      "cellClick": _vm.runApp
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '执行指令的接口(launchLinkService)'
	    },
	    on: {
	      "cellClick": _vm.launchLinkService
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开应用中心(openAppMarket)'
	    },
	    on: {
	      "cellClick": _vm.openAppMarket
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '打开收藏应用中心(openServiceMarketDesktop)'
	    },
	    on: {
	      "cellClick": _vm.openServiceMarketDesktop
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '获取本地收藏的应用(getFavoriteApp)'
	    },
	    on: {
	      "cellClick": _vm.getFavoriteApp
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"

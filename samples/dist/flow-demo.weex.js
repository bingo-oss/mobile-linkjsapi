...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _flowDemo = __webpack_require__(172);

	var _flowDemo2 = _interopRequireDefault(_flowDemo);
	...
	_flowDemo2.default.el = '#root';

	new Vue(_flowDemo2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/notgreenl/githup/bui-weex-linkapi/src/views/flow-demo.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-9e2b2156"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        queryAllSchedule: function queryAllSchedule() {
	            var _this = this;

	            this.linkapi.queryAllSchedule(function (result) {
	                _this.$alert("成功回调");
	                _this.$alert(result);
	            }, function (error) {
	                _this.$alert("失败回调");
	        ...
	        insertOrUpdateSchedule: function insertOrUpdateSchedule() {
	            var _this2 = this;

	            this.linkapi.getLoginInfo(function (res) {
	                _this2.$alert(res);
	                _this2.linkapi.insertOrUpdateSchedule({
	        ...
	        querySchedule: function querySchedule() {
	            this.linkapi.querySchedule();
	        },
	        shareWebsize: function shareWebsize() {
	            var _this3 = this;
	        ...
	        shareToMessage: function shareToMessage() {
	            var _this5 = this;
	        ...
	        shareToBlog: function shareToBlog() {
	            var _this6 = this;
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('bui-header', {
	    ...
	    attrs: {
	      "title": '打开自由流程页面(startProcess)'
	    },
	    on: {
	      "cellClick": _vm.startProcess
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	    ...
	    attrs: {
	      "title": '打开我的工作页面(openProcessMywork)'
	    },
	    on: {
	      "cellClick": _vm.openProcessMywork
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '日程，调用系统的日程接口(insertOrUpdateSchedule)'
	    },
	    on: {
	      "cellClick": _vm.insertOrUpdateSchedule
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '(queryAllSchedule)'
	    },
	    on: {
	      "cellClick": _vm.queryAllSchedule
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '分享内容到Link-链接(share)'
	    },
	    on: {
	      "cellClick": _vm.shareWebsize
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '分享内容到Link-应用(share)'
	    },
	    on: {
	      "cellClick": _vm.shareApp
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '内容分享到聊天（个人/群组)(shareToMessage)'
	    },
	    on: {
	      "cellClick": _vm.shareToMessage
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
	    ...
	    attrs: {
	      "title": '内容分享到动态(shareToBlog)'
	    },
	    on: {
	      "cellClick": _vm.shareToBlog
	    }
	  }, [_c('bui-icon', {
	    attrs: {
	      "name": "ion-ios-arrow-right"
